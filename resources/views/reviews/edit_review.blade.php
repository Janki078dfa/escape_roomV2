...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card my-5">
                <form class="card-body cardbody-color p-lg-5" action="{{ url('EditReviewController') }}" method="post">
                    @csrf
                    ...
                    <div class="mb-3">
                        <input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp"
                               placeholder="Name:" value="{{ $review->comment }}">
                    </div>

                    <div class="mb-3">
                        <input type="text" class="form-control" id="date" name="company"
                               aria-describedby="emailHelp"
                               placeholder="DNI:" value="{{ $review->rate }}">
                    </div>
