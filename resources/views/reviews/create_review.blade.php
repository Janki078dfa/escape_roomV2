...
<div class="container">
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card my-5">
                <form class="card-body cardbody-color p-lg-5" action="{{ url('CreateReviewController') }}"
                      method="post">
                    @csrf
                    ...
                    <div class="mb-3">
                        <input type="number" class="form-control" id="name" name="rate" aria-describedby="emailHelp"
                               placeholder="Rate:">
                    </div>
